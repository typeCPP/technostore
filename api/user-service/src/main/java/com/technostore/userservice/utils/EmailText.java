package com.technostore.userservice.utils;

public class EmailText {
    static final public String firstPartEmailText = "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n" +
            "<head>\n" +
    ...
    static final public String secondPаrtEmailText = "</td>\n" +
            "                </tr>\n" +
            "                <tr>\n" +
            "                    <td align=\"center\" valign=\"top\"\n" +
            "                        style=\"border-collapse: collapse; border-spacing: 0;\n" +
            "                        margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%;\n" +
            "                        width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;\n" +
            "                        padding-top: 15px; color: #FFFFFF; font-family: sans-serif;\"\n" +
            "                        class=\"paragraph\">";
    static final public String thirdPаrtEmailText = "   </td>\n" +
            "                </tr>\n" +
            "                <tr>\n" +
            "                    <td align=\"center\" valign=\"top\"\n" +
            "                        style=\"border-collapse: collapse; border-spacing: 0;\n" +
            "                        margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%;\n" +
            "                        width: 87.5%; padding-top: 25px; padding-bottom: 5px;\" class=\"button\">\n" +
            "                        <a target=\"_blank\">\n" +
            "                            <table style=\"max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;\">\n" +
            "                                <tr>\n" +
    ...
    static final public String fourthPartEmailText = " </a>\n" +
            "                                    </td>\n" +
            "                                </tr>\n" +
            "                            </table>\n" +
            "                        </a>\n" +
            ...
            "                        Если Вы не запрашивали код в приложение TechnoStore, проигнорируйте это письмо и никому не\n" +
            "                        сообщайте код.\n" +
            "                    </td>\n" +
            "                </tr>\n" +
            "            </table>\n" +
